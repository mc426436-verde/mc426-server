(function() {
    ...
    DeviceDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Device', 'Room', 'Share'];

    function DeviceDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Device, Room, Share) {
        var vm = this;
        vm.device = entity;
        vm.rooms = Room.query();
